package com.example.unitalk.activities;
...
import com.example.unitalk.databinding.ActivityCallingBinding;
import com.example.unitalk.models.InterfaceJava;
        ...
        if(createdBy.equalsIgnoreCase(username)) {
            ...
            FirebaseDatabase.getInstance().getReference().child("profiles").child(friendsUsername).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    Glide.with(CallingActivity.this).load(user.getProfile()).into(binding.profile);
